      ...
      <div className="stickFooterInner">
        <div className="stickFooterGrid">
          ...
          <div>
            ...
            <ul>
              ...
              <li><a href="https://github.com/stickpump/stick" target="_blank" rel="noreferrer">GitHub</a></li>
            </ul>
          </div>
        ...
        <div className="stickFooterBottom">
          ...
          <div className="footerBottomLinks">
            ...
            <a href="https://github.com/stickpump/stick" target="_blank" rel="noreferrer" aria-label="GitHub">
